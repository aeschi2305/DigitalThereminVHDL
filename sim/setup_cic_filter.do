...
add wave -noupdate /cic_tb/audio_out
add wave -noupdate /cic_tb/verify_pm/p_write/v_data_write
...
WaveRestoreCursors {{Cursor 1} {1063 ns} 0}
...
update
WaveRestoreZoom {39800 ns} {40120 ns}
